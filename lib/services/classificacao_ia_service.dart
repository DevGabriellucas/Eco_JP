...
/// Sugestão de categoria por IA (Gemini via Firebase AI Logic).
///
/// Protegido pelo Firebase App Check já ativo no projeto — nenhuma chave de
/// API fica no app, e a chamada só funciona vindo do app real instalado.
