...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: Routes.inicial, builder: (_, _) => const InicialPage()),
      GoRoute(path: Routes.login, builder: (_, _) => const LoginPage()),
      GoRoute(path: Routes.cadastro, builder: (_, _) => const CadastroPage()),
      GoRoute(
        path: Routes.verificacaoEmail,
        builder: (_, _) => const VerificacaoEmailPage(),
      ),
      GoRoute(
        path: Routes.consentimento,
        builder: (_, _) => ConsentimentoPage(
          onAceitar: () async {
      ...
      GoRoute(
        ...
        builder: (_, _) => const FormOcorrenciaPage(),
      ),
      GoRoute(
        path: Routes.filaVerificacao,
        builder: (_, _) => const FilaVerificacaoPage(),
      ),
      GoRoute(
        path: Routes.filaModeracao,
        builder: (_, _) => const FilaModeracaoPage(),
      ),
      GoRoute(
...
class _RouterNotifier extends ChangeNotifier {
  _RouterNotifier(this._ref) {
    ...
    _ref.listen(consentStatusProvider, (_, _) => notifyListeners());
  }
